...
insert into ProductsToCategories(PID, CAID) values (1, 4);
insert into ProductsToCategories(PID, CAID) values (2, 4);
insert into ProductsToCategories(PID, CAID) values (3, 4);
insert into ProductsToCategories(PID, CAID) values (4, 4);
...
AS
select ID from Customers where Secretword = @SecretWord AND Email = @Email
